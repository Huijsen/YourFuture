...
// Category → difficulty (1–5) → expected minutes
export const categoryExpectedTimes: Record<string, Record<number, number>> = {
...
// Category → base skill weight (will be updated dynamically in mainML.ts)
export const categorySkillWeights: Record<string, number> = {
  fitness: 1.6,
  music: 1.4,
  coding: 1.3,
  art: 1.2,
